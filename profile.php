        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15" style="align-items: center;">Hello, Welcome to your account..</span><br>
              <form id="stripe-login" method="post" enctype="multipart/form-data">

              	<div class="field padding-bottom--24">
                  <label for="email"><img src="images/<?php echo htmlentities($result->image);?>" style="width:100px; border-radius:50%; margin:10px;"></label>
                ...
                <div class="field padding-bottom--24">
                  ...
                  <input type="text" name="mobile" required value="<?php echo htmlentities($result->mobile);?>">
                </div>

                <div class="field padding-bottom--24">
                  <label for="email">Designation</label>
                  <input type="text" name="designation" required value="<?php echo htmlentities($result->designation);?>">
                </div>
