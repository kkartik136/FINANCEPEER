        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" method="post" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
          ...
          <div class="footer-link padding-top--24">
            <span style="font-size: 15px;">Already have an account? <a href="index.php">Sign in</a></span></div>
          </div>
      </br></br></br></br></br></br>
